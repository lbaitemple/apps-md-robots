            ...
            try:
                ...
                if self.is_currently_speaking and self.consecutive_silent_frames >= self.num_silent_frames_threshold:
                    ...
                    if self.accumulated_audio:
                        ...
                        # Transcribe; returns (transcript, detected_lang_code)
                        transcript, detected_lang = self.transcribe_audio(audio_bytes)
...
def stt_task():
    ...
    while True:
        ...
        if playing_heads_up:
            ...
            output_text_queue.put(GAME_TEXTS.get(rps_game_lang, GAME_TEXT))
        elif lang:
...
def tts_task():
    ...
    while True:
        ...
        if out_text in ({GAME_TEXT} | set(GAME_TEXTS.values())):
...
def main():
    ...
    logging.info("="*60)
    logging.info("AI APP 7 - VISUAL FEEDBACK + AUTO FOREIGN LANGUAGE TTS")
